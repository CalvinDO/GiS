...
(function (Eisladen) {
    ...
    class IncomingOrderDisplay {
        ...
        checkForData() {
            this.communicate(this.baseURL, Eisladen.ActionTypes.get);
        }
        async communicate(_sendURL, _actionType) {
        ...
        drawHorizontalBelt(_position, _dimensions) {
            ...
            for (let index = 0; index < this.wheelAmount; index++) {
                ...
                let xPos = (_position.x + _dimensions.x) - (this.wheelRadius + _position.x + index * (this.wheelRadius * 2 + this.wheelBorderRadius));
        ...
        drawVerticalBelt(_position, _dimensions) {
            ...
            for (let index = 0; index < this.wheelAmount; index++) {
                let yPos = _position.y + (index) * (vWheelRadius * 2) + vWheelRadius;
